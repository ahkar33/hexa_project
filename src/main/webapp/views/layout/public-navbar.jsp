	...
	<div class="container justify-content-between">
		...
		<ul class="navbar-nav gap-4 d-flex align-items-center" id="navbar-nav">
			...
			<c:if test="${sessionScope.userInfo == null}">
				<li class="nav-item"><a href="/hexa/login"
					class="text-primary shadow-sm p-1 fw-bold">Sign In</a></li>
				<li class="nav-item"><a href="/hexa/register"
					class="text-success  shadow-sm p-1  fw-bold">Sign Up</a></li>
			</c:if>
			...
			<form action="/hexa/editUser" method="POST" class="modal-body">
				<div class="form-group my-1">
					...
					<input type="hidden" name="id"
						value="${sessionScope.userInfo.user_id}" /> <label for=""
						class="form-label fw-bold text-danger">Username</label> <input
				...
				<div class="form-group my-1">
					...
					<input type="password" name="psw" class="form-control"
						value="${sessionScope.userInfo.user_password}" />
				</div>
				<div
