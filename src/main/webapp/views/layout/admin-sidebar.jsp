<section id="sidebar" class="dark-bg p-0 m-0 position-relative">
            ...
            <ul id="sidebar-list" class="list-group  gap-2 w-100">
               ...
               <!-- for categories -->
               <li id="sidebar-item" class="list-item p-2 px-3 m-0"><a href="/hexa/admin/manageCategories"  class="w-100"><i class="fa-solid fa-layer-group"></i><span class="mx-2">Categories</span></a></li>
