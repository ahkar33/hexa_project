...
<body>
    ...
    <section id="search"  class="container-fluid row my-4">
        <form action="" method="GET" modelAttribute="" class="form col-xl-8 col-md-12 mx-auto d-flex -justify-content-start align-items-center gap-1">
            <input type="search" class="form-control" id="search-val" placeholder="Search you want "/>
            <button type="submit" class="btn btn-primary btn-sm"><i class="fa-solid fa-magnifying-glass btn"></i></button>
        </form>
    </section>
	

	<!-- footer -->
	<footer id="footer" class="w-100 p-3 m-0 " style="transform:translateY(600%);">
